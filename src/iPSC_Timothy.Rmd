...
```{r method.diff, echo=TRUE, message=TRUE}
library(lmerTest)
ds = names(dupCorList)[3]
...
# dream p-values
topTable(dreamList[[ds]], number=Inf, sort.by="none")[j,]

# duplicateCorrelation results
topTable(dupCorList[[ds]]$fitDupCor, number=Inf, sort.by="none")[j,]
