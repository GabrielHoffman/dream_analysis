...
pvals[['lm on Individual averages']] = coef(summary(lm( Expression ~ Genotype, data)))[2,4]

library(knitr)
kable(data.frame( p.value = sapply(pvals, function(x) format(x, digits=2, scientific=3))))
```
