...
## DE versus eQTL
```{r DE.vs.eQTL, echo=TRUE, fig.height=12, fig.width=12}
...
figList = foreach( ds = names(dupCorList) ) %do% {
  ...
  dfeqtl = data.table(merge(df_vp2,dfr2, by.x="ensembl_gene_id", by.y="gene", all.x=TRUE))
