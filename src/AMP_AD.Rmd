...
fig1 = plotStratify( Expression ~ Indiv, GE, colorBy = GE$bbscore, main= ensGene, legend=TRUE) + theme(aspect.ratio=1, legend.position="right") + scale_fill_continuous(name = "Braak stage") + scale_color_continuous()
