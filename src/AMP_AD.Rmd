...
fig1 = plotStratify( Expression ~ Indiv, GE, colorBy = GE$bbscore, main= ensGene, legend=TRUE) + theme(aspect.ratio=1, legend.position="right", legend.key=element_rect(fill = "transparent")) 
