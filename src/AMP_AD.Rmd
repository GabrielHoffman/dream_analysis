...
plotStratify( GE, 'Indiv', 'Expression', colorBy = 'bbscore', main= ensGene, legend=FALSE) + theme(aspect.ratio=1, legend.position="right") + scale_color_continuous(name = "Braak stage")
