...
fig1 = plotStratify( Expression ~ Indiv, GE, colorBy = GE$bbscore, main= ensGene, legend=FALSE) 
fig1 = fig1 + scale_color_continuous(name = "Braak stage") + theme(aspect.ratio=1, legend.position="right") 
