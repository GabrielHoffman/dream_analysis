...
t2 = topTable(fitDream_neuron_eb, coef="L1", number=Inf, sort.by="none")$P.Value
...
t2 = topTable(fitDream_npc_eb, coef="L1", number=Inf, sort.by="none")$P.Value
...
res = topTable(fitDream_npc_eb, coef="L1", number=Inf, sort.by='P')
camera_dream_npc = get_enrich_order( res )

res = topTable(fitDream_neuron_eb, coef="L1", number=Inf , sort.by='P')
...
write.table(topTable(fitDream_npc_eb, coef="L1", number=Inf), file=file, sep="\t", quote=FALSE)
file = "./COS_neuron_dream.tsv"
write.table(topTable(fitDream_neuron_eb, coef="L1", number=Inf), file=file, sep="\t", quote=FALSE)
